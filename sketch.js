...
var brokenspriteimage
var brokenanimation=[]

function preload() {
  backgroundimage = loadImage("assets/background.gif");
  boatspritedata=loadJSON("assets/boat/boat.json")
  boatspriteimage=loadImage("assets/boat/boat.png")
  brokenspritedata=loadJSON("assets/boat/broken_boat.json")
  brokenspriteimage=loadImage("assets/boat/broken_boat.png")
}
...
function setup() {
  ...
  for(var i=0; i<boatsFrames.length ;i+=1){
    var p=boatsFrames[i].position
    var Img=boatspriteimage.get (p.x,p.y,p.w,p.h)
  ...
  for(var i=0; i<brokenFrames.length ;i+=1){
    ...
    var Img=brokenspriteimage.get (p.x,p.y,p.w,p.h)
...
// function greeting(){
//    console.log("Hii Havisha,How are you??") } 
